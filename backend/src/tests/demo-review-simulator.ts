...
function printMenu() {
  console.log('\n================================================================================');
  console.log('🤖 365MEO - 自主テスト用・口コミ自動判定＆LINE実機連動シミュレーター');
  console.log('================================================================================');
  ...
  console.log('4. 【星2】渡辺様の低評価（接客態度不満） ➔ Claude謝罪作成 ＆ スマホLINEプッシュ！');
  console.log('5. 【星1】怒り男様の最低評価（予約放置）  ➔ Claude謝罪作成 ＆ スマホLINEプッシュ！');
